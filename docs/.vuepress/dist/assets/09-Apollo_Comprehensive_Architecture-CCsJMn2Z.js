import{a as e,c as t,i as n,l as r,s as i,t as a}from"./app-B8uz0aqq.js";var o=JSON.parse(`{"path":"/09-Apollo_Comprehensive_Architecture.html","title":"Apollo MMORPG 服务器综合架构设计方案","lang":"en-US","frontmatter":{},"filePathRelative":"09-Apollo_Comprehensive_Architecture.md","git":{"createdTime":1765122408000,"updatedTime":1767059850000,"contributors":[{"name":"cuihairu","username":"cuihairu","email":"chuihairu@gmail.com","commits":2,"url":"https://github.com/cuihairu"}]}}`),s={name:`09-Apollo_Comprehensive_Architecture.md`};function c(a,o,s,c,l,u){let d=r(`Mermaid`);return t(),n(`div`,null,[o[0]||=e(`<h1 id="apollo-mmorpg-服务器综合架构设计方案" tabindex="-1"><a class="header-anchor" href="#apollo-mmorpg-服务器综合架构设计方案"><span>Apollo MMORPG 服务器综合架构设计方案</span></a></h1><blockquote><p><strong>版本</strong>: 1.0 <strong>更新日期</strong>: 2024-12-06 <strong>核心目标</strong>: 构建高性能、高可用、易扩展的现代化 MMORPG 服务器框架</p></blockquote><h2 id="_1-架构设计哲学" tabindex="-1"><a class="header-anchor" href="#_1-架构设计哲学"><span>1. 架构设计哲学</span></a></h2><h3 id="_1-1-核心原则" tabindex="-1"><a class="header-anchor" href="#_1-1-核心原则"><span>1.1 核心原则</span></a></h3><ol><li><p><strong>关注点分离</strong></p><ul><li>空间计算(AOI)与业务逻辑分离</li><li>存储与计算分离</li><li>网络层与业务层解耦</li></ul></li><li><p><strong>性能优先</strong></p><ul><li>零拷贝设计</li><li>内存池管理</li><li>异步非阻塞架构</li></ul></li><li><p><strong>可扩展性</strong></p><ul><li>微服务化架构</li><li>水平扩展能力</li><li>插件化设计</li></ul></li><li><p><strong>工程化实践</strong></p><ul><li>现代C++20标准</li><li>自动化构建与测试</li><li>完整的监控体系</li></ul></li></ol><h3 id="_1-2-架构分层" tabindex="-1"><a class="header-anchor" href="#_1-2-架构分层"><span>1.2 架构分层</span></a></h3>`,6),i(d,{code:``}),o[1]||=e(`<h2 id="_2-核心服务详细设计" tabindex="-1"><a class="header-anchor" href="#_2-核心服务详细设计"><span>2. 核心服务详细设计</span></a></h2><h3 id="_2-1-网关服务-gateserver" tabindex="-1"><a class="header-anchor" href="#_2-1-网关服务-gateserver"><span>2.1 网关服务 (GateServer)</span></a></h3><h4 id="职责" tabindex="-1"><a class="header-anchor" href="#职责"><span>职责</span></a></h4><ul><li>客户端连接管理</li><li>协议解析与封包</li><li>消息路由转发</li><li>DDoS防护与限流</li><li>玩家会话管理</li></ul><h4 id="核心特性" tabindex="-1"><a class="header-anchor" href="#核心特性"><span>核心特性</span></a></h4><div class="language-cpp line-numbers-mode" data-highlighter="prismjs" data-ext="cpp"><pre><code class="language-cpp"><span class="line"><span class="token keyword">class</span> <span class="token class-name">GateServer</span> <span class="token punctuation">{</span></span>
